                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildStatRow(
                          ...
                          iconColor: isComputer ? AppColors.primaryComputerLight : const Color(0xFF92400E),
                          label: 'Sejarah',
                          value: '${progress.historySolved} / 100',
                          isDark: isDark,
                          isComputer: isComputer,
                        ),
                        Divider(color: isDark ? Colors.white.withValues(alpha: 0.06) : (isComputer ? AppColors.surfaceComputerBorder : Colors.black.withValues(alpha: 0.06)), height: 28),
                        _buildStatRow(
                          ...
                          iconColor: isComputer ? AppColors.primaryComputerLight : const Color(0xFF4F46E5),
                          label: 'TIK',
                          value: '${progress.itSolved} / 100',
                          isDark: isDark,
                          isComputer: isComputer,
                        ),
                        Divider(color: isDark ? Colors.white.withValues(alpha: 0.06) : (isComputer ? AppColors.surfaceComputerBorder : Colors.black.withValues(alpha: 0.06)), height: 28),
